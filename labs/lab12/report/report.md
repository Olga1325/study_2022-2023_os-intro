...
и более процессов(рис. [-@fig:pic1]) (рис. [-@fig:pic2]).
...
файл должен получать в виде аргумента командной строки название команды и в виде
результата выдавать справку об этой команде или сообщение об отсутствии справки,
если соответствующего файла нет в каталоге man1(рис. [-@fig:pic3]) (рис. [-@fig:pic4]) (рис. [-@fig:pic5]).
...
щий случайную последовательность букв латинского алфавита(рис. [-@fig:pic6]) (рис. [-@fig:pic7]).
...
[1. Лабораторная работа №12](https://esystem.rudn.ru/pluginfile.php/1975783/mod_resource/content/4/012-lab_shell_prog_3.pdf)
